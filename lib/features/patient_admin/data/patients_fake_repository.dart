...
class PatientsFakeRepository {
  Bundle getPatients() => Bundle.fromJson({
        "resourceType": "Bundle",
        ...
        "link": [
          {
            "relation": "self",
            "url":
                "http://dursamrscit.services.brown.edu/openmrs/ws/fhir2/R4/Patient"
          },
          {
            "relation": "next",
            "url":
                  ...
                  "extension": [
                    {
                      ...
                      "valueReference": {
                        "reference":
                            "Location/736b08f9-94d6-4b50-ad58-6bc69b9cbfb8",
                        "type": "Location",
                        "display": "Ward 50"
                      }
                    }
